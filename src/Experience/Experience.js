...
import MonitorRendimiento from './Utils/MonitorRendimiento.js'
...
export default class Experience {
  constructor(_canvas) {
    ...
    this.gui = new GUI({ title: 'Panel de Control', width: 320 })

    this.raycaster = new Raycaster(this, this.gui)
    this.monitor = new MonitorRendimiento(this.gui)
